...
class NeuralNetwork(object):
    ...
    def train(self, inputs_list, targets_list):
        ...
        # print("inputs_list_2d: ", inputs)
        # print("targets_list_2d: ", targets)
...
#         del_w_hidden_output = np.zeros(self.weights_hidden_to_output.shape)
        ...
        final_outputs = final_inputs # signals from final output layer. activation function is f(x) = x
        ...
        #output error gradient = error*f'(h)
        ...
        del_w_hidden_output = output_error*hidden_outputs
        # print("del_w_hidden_output shape: ", del_w_hidden_output.shape)
        
        del_w_input_hidden = hidden_error*inputs.T
        # print("del_w_input_hidden shape: ", del_w_input_hidden.shape)
        
        # TODO: Update the weights
        # print("self.weights_hidden_to_output: ", self.weights_hidden_to_output.shape)
        self.weights_hidden_to_output += self.lr*del_w_hidden_output.T # update hidden-to-output weights with gradient descent step
